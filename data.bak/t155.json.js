window.repositoryObject = {
  ...
  columns: [
    {
      ...
      linked_terms: [],
      references: [
        { id: "t360", name: "TRESPASS", name_show_schema: "dbo.TRESPASS" },
      ],
      linked_lookup: null,
    },
    {
      id: "column-3367",
      object_id: "column-3367",
      name: "ATTACHCAT",
      name_without_path: "ATTACHCAT",
      description: "Trespasser Attachment Type",
      is_pk: false,
      is_identity: false,
      data_type: "varchar",
      data_length: "2",
  ...
  summary: [
    ...
    { field: "Name", value: "TRESPASSATTACH" },
