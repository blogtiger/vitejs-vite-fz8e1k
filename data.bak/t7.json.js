window.repositoryObject = {
  ...
  columns: [
    ...
    {
      id: "column-205",
      object_id: "column-205",
      name: "NWID",
      name_without_path: "NWID",
      description: "NW ID",
      is_pk: true,
      is_identity: false,
      data_type: "int",
  ...
  unique_keys: [
    {
      ...
      is_user_defined: false,
      columns: [
        { path: null, name_without_path: "ID", name: "ID", column_id: 204 },
        { path: null, name_without_path: "NWID", name: "NWID", column_id: 205 },
      ],
      custom_fields: {},
    },
  ],
