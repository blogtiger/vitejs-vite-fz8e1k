window.repositoryObject = {
  ...
  columns: [
    ...
    {
      id: "column-5403",
      object_id: "column-5403",
      name: "REQ_TYPE",
      name_without_path: "REQ_TYPE",
      description: "Appointment Type (Jail Module)",
      is_pk: false,
      is_identity: false,
      data_type: "varchar",
      data_length: "2",
    ...
    {
      id: "column-5404",
      object_id: "column-5404",
      name: "REQ_DATE",
      name_without_path: "REQ_DATE",
      description: "Date",
      is_pk: false,
      is_identity: false,
      data_type: "datetime",
    ...
    {
      id: "column-5405",
      object_id: "column-5405",
      name: "REQ_TIME",
      name_without_path: "REQ_TIME",
      description: "Time",
      is_pk: false,
      is_identity: false,
      data_type: "varchar",
    ...
    {
      id: "column-5406",
      object_id: "column-5406",
      name: "REQ_REASON",
      name_without_path: "REQ_REASON",
      description: "Reason",
      is_pk: false,
      is_identity: false,
      data_type: "image",
    ...
    {
      id: "column-5409",
      object_id: "column-5409",
      name: "SEEN_DATE",
      name_without_path: "SEEN_DATE",
    ...
    {
      id: "column-5410",
      object_id: "column-5410",
      name: "SEEN_TIME",
      name_without_path: "SEEN_TIME",
    ...
    {
      id: "column-5411",
      object_id: "column-5411",
      name: "SEEN_BY",
      name_without_path: "SEEN_BY",
      description: "Seen By",
      is_pk: false,
      is_identity: false,
      data_type: "varchar",
    ...
    {
      id: "column-5412",
      object_id: "column-5412",
      name: "RESULTS",
      name_without_path: "RESULTS",
      description: "Results",
      is_pk: false,
      is_identity: false,
      data_type: "image",
    ...
    {
      id: "column-5415",
      object_id: "column-5415",
      name: "END_DATE",
      name_without_path: "END_DATE",
    ...
    {
      id: "column-5418",
      object_id: "column-5418",
      name: "VISITATION_LOCATION",
      name_without_path: "VISITATION_LOCATION",
      description: "Visitation   Location",
      is_pk: false,
      is_identity: false,
      data_type: "varchar",
      data_length: "4",
  ...
  summary: [
    ...
    { field: "Name", value: "INM_APPT_REQUESTS" },
