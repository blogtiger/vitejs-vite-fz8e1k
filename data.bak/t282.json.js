window.repositoryObject = {
  ...
  columns: [
    {
      id: "column-6247",
      object_id: "column-6247",
      name: "ORDERKEY",
      name_without_path: "ORDERKEY",
      description: "Suboena ID",
      is_pk: false,
      is_identity: false,
      data_type: "int",
      data_length: null,
    ...
    {
      id: "column-6248",
      object_id: "column-6248",
      name: "ATTACHCAT",
      name_without_path: "ATTACHCAT",
      description: "Subpoena Attachment Type",
      is_pk: false,
      is_identity: false,
      data_type: "varchar",
      data_length: "2",
  ...
  summary: [
    ...
    { field: "Name", value: "SUBPOENAATTACH" },
