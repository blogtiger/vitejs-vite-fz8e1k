window.repositoryObject = {
  ...
  columns: [
    {
      ...
      linked_terms: [],
      references: [
        { id: "t265", name: "MISSING", name_show_schema: "dbo.MISSING" },
      ],
      linked_lookup: null,
    },
    {
      id: "column-6085",
      object_id: "column-6085",
      name: "ATTACHCAT",
      name_without_path: "ATTACHCAT",
      description: "Missing Person Attachment Type",
      is_pk: false,
      is_identity: false,
      data_type: "varchar",
      data_length: "2",
  ...
  summary: [
    ...
    { field: "Name", value: "MISSINGATTACH" },
