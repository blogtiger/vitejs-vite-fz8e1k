window.repositoryObject = {
  ...
  columns: [
    ...
    {
      id: "column-4678",
      object_id: "column-4678",
      name: "DATE",
      name_without_path: "DATE",
    ...
    {
      id: "column-4679",
      object_id: "column-4679",
      name: "TIME",
      name_without_path: "TIME",
      description: "Charting Time",
      is_pk: false,
      is_identity: false,
      data_type: "varchar",
      data_length: "5",
    ...
    {
      id: "column-4680",
      object_id: "column-4680",
      name: "PROVIDER",
      name_without_path: "PROVIDER",
      description: "Charting Provider",
      is_pk: false,
      is_identity: false,
      data_type: "varchar",
      data_length: "30",
    ...
    {
      id: "column-4681",
      object_id: "column-4681",
      name: "ORDERS",
      name_without_path: "ORDERS",
      description: "Charting Orders",
      is_pk: false,
      is_identity: false,
      data_type: "text",
      data_length: null,
    ...
    {
      id: "column-4682",
      object_id: "column-4682",
      name: "NOTES",
      name_without_path: "NOTES",
      description: "Charting Notes",
      is_pk: false,
      is_identity: false,
      data_type: "text",
      data_length: null,
  ...
  summary: [
    ...
    { field: "Name", value: "INM_MEDICAL_CHART" },
