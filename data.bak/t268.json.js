window.repositoryObject = {
  ...
  columns: [
    {
      id: "column-6052",
      object_id: "column-6052",
      name: "CCWKEY",
      name_without_path: "CCWKEY",
      description: "CCW Key",
      is_pk: false,
      is_identity: false,
      data_type: "int",
      ...
      custom_fields: {},
      linked_terms: [],
      references: [{ id: "t262", name: "CCW", name_show_schema: "dbo.CCW" }],
      linked_lookup: null,
    },
    {
      id: "column-6053",
      object_id: "column-6053",
      name: "ATTACHCAT",
      name_without_path: "ATTACHCAT",
      description: "CCW Attachment Categories",
      is_pk: false,
      is_identity: false,
      data_type: "varchar",
      data_length: "2",
