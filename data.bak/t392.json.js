window.repositoryObject = {
  ...
  columns: [
    {
      id: "column-9342",
      object_id: "column-9342",
      name: "PHONEKEY",
      name_without_path: "PHONEKEY",
      description: "PHONE RECORD KEY",
      is_pk: false,
      is_identity: false,
      data_type: "int",
      data_length: null,
      ...
      linked_terms: [],
      references: [
        { id: "t215", name: "PHONE", name_show_schema: "dbo.PHONE" },
      ],
      linked_lookup: null,
    },
    {
      id: "column-9343",
      object_id: "column-9343",
      name: "ATTACHCAT",
