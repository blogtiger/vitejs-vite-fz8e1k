window.repositoryObject = {
  ...
  columns: [
    {
      ...
      linked_terms: [],
      references: [
        { id: "t127", name: "NARCOFF", name_show_schema: "dbo.NARCOFF" },
      ],
      linked_lookup: null,
    },
    {
      id: "column-2968",
      object_id: "column-2968",
      name: "ATTACHCAT",
      name_without_path: "ATTACHCAT",
      description: "Narcotics Offender Attachment Type",
      is_pk: false,
      is_identity: false,
      data_type: "varchar",
      data_length: "2",
  ...
  summary: [
    ...
    { field: "Name", value: "NARCOFFATTACH" },
