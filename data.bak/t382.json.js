window.repositoryObject = {
  ...
  columns: [
    {
      id: "column-9007",
      object_id: "column-9007",
      name: "RDYREFKEY",
      name_without_path: "RDYREFKEY",
      description: "RDYREF Key",
      is_pk: false,
      is_identity: false,
      data_type: "int",
      data_length: null,
      ...
      linked_terms: [],
      references: [
        { id: "t336", name: "RDYREF", name_show_schema: "dbo.RDYREF" },
      ],
      linked_lookup: null,
    },
    {
      id: "column-9008",
      object_id: "column-9008",
      name: "ATTACHCAT",
      name_without_path: "ATTACHCAT",
      description: "Ready Reference Attachment Categories",
      is_pk: false,
      is_identity: false,
      data_type: "varchar",
      data_length: "2",
