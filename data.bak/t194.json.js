window.repositoryObject = {
  ...
  columns: [
    {
      ...
      linked_terms: [],
      references: [
        { id: "t383", name: "ARSONIST", name_show_schema: "dbo.ARSONIST" },
      ],
      linked_lookup: null,
    },
    {
      id: "column-4316",
      object_id: "column-4316",
      name: "ATTACHCAT",
      name_without_path: "ATTACHCAT",
      description: "Arsonist Attachment Categories",
      is_pk: false,
      is_identity: false,
      data_type: "varchar",
      data_length: "2",
  ...
  summary: [
    ...
    { field: "Name", value: "ARSONISTATTACH" },
