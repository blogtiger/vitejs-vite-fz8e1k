window.repositoryObject = {
  ...
  unique_keys: [
    {
      name: "PK_INM_PROPPHOTOS",
      description: null,
      is_pk: true,
      is_user_defined: false,
      columns: [
        { path: null, name_without_path: "PID", name: "PID", column_id: 310 },
        {
          path: null,
          name_without_path: "PHOTOINDEX",
          name: "PHOTOINDEX",
  ...
  summary: [
    ...
    { field: "Name", value: "INM_PROPPHOTOS" },
